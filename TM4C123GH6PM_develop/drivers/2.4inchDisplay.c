...
// Touch flag, set by touch_int_handler(), cleared by the application.
...
void touch_request_coords(void){
    ...
    // rotated 90 degrees.
    touch_x = (XPT2046_SCREEN_W - 1) - touch_scale(raw_x, XPT2046_X_MIN, XPT2046_X_MAX, XPT2046_SCREEN_W - 1);
    touch_y = (XPT2046_SCREEN_H - 1) - touch_scale(raw_y, XPT2046_Y_MIN, XPT2046_Y_MAX, XPT2046_SCREEN_H - 1);
}
